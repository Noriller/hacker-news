export function PostSkeleton() {
  return (
    <div className="container w-[70%] animate-pulse rounded-lg bg-gradient-to-r from-[#8029d688] to-[#ff008088] p-2">
      <span className="sr-only">Loading...</span>
      <div className="bg-black p-4">
        <div className="mb-2 flex justify-between rounded-2xl border-2 border-white p-2 align-middle text-2xl">
